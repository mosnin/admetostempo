  ...
  return (
    <div className="min-h-[60vh] flex items-center justify-center">
      <div className="bg-white/80 backdrop-blur-xl rounded-3xl p-10 max-w-sm mx-4 text-center shadow-xl">
        ...
        <p className="text-slate-500 mb-8">This history page doesn&apos;t exist or was moved.</p>
        <Link href="/dashboard"><Button variant="primary" className="w-full">Go home</Button></Link>
      </div>
    </div>
  )
}
